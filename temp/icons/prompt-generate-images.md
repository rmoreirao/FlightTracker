I have an APP to track flights, and need to generate an fav.ico for that. Generate it for me. The name of the App is "Flight Tracker", below is the UI design standard of the app:
